...
def track_detail(request, track_id):
    ...
    # Prioritize Spotify audio features
    if track.spotify_id and not track.audio_features:
        try:
            # sp is already initialized
            ...
            print(f"Error fetching Spotify audio features directly in track_detail for {track.spotify_id}: {e}")

    # Fallback to JioSaavn/Librosa if still no audio_features (will be modified in Part B)
